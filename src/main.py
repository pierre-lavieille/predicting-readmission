...
parser = argparse.ArgumentParser(description='Bank Industrialised ML Project',
epilog="This has been developped by Pierre Lavieille")
...
def main(logger, step_list, NB_STEP_TOT, path_conf = '../conf/conf.json'):
    ...
    if (step == 5) or (5 in step_list):
        ...
        dice_interpretability = interpretability.dice_interpretability(clf, X_test, y_test, conf)
